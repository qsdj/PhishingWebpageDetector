...
def FeatureExtraction(url_input):
    ...
    for n in product_domain_names:
        name = ''
        name = 'url_levenshtein_distance_' + n
        Features[name] = Levenshtein.distance(url_input, n)

    for n in product_domain_names:
        name = ''
        name = 'fqdn_levenshtein_distance_' + n
        Features[name] = Levenshtein.distance(fqdn, n)
